...
const Gauge = (props) => {
  ...
  return (
    <div class="flex flex-col justify-center item-center bg-gray-00 p-4 rounded-lg w-full md:w-[180px] h-[180px] shadow-lg">
      <h1 class="text-center text-m font-bold text-gray-800 mb-4">{props.label || "Metering"}</h1>
      <div class="flex justify-center items-center h-screen">
        <div class="relative w-60 md:w-24 h-24">
          <svg
            viewBox="0 0 100 100"
